...
const REQUIRED = [
	...
	/(^|\/)harnesses\/hermes\/bundle\/session-start\.js$/, // Hermes lifecycle hook alias
	/(^|\/)harnesses\/hermes\/bundle\/capture\.js$/, // Hermes capture + recall hook alias
	/(^|\/)harnesses\/hermes\/bundle\/session-end\.js$/, // Hermes finalization hook alias
