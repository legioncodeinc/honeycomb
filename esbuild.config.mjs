...
const CJS_REQUIRE_BANNER = "import { createRequire as __cr } from 'node:module'; const require = __cr(import.meta.url);";
...
const HOOK_HARNESSES = [
	...
	},
	{
		...
		aliases: ["session-start.js", "capture.js", "session-end.js"],
	},
