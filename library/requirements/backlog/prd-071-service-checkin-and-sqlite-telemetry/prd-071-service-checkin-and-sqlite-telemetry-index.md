...
- [Queen PRD-007: Fleet Observation](../../../../../queen/library/requirements/backlog/prd-007-fleet-observation-control-plane/prd-007-fleet-observation-control-plane-index.md) (was honeycomb PRD-054; honeycomb stub remains at [`prd-054`](../prd-054-fleet-observation-control-plane/prd-054-fleet-observation-control-plane-index.md)) - the read-only-dashboard portion is superseded by the realignment; presence-store precedent for local SQLite telemetry.
