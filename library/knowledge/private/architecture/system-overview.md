...
|---|---|---|
| Daemon | honeycomb daemon, port 3850 | Capture intake, pipeline, retrieval, ontology, dreaming, router, workers. Only DeepLake client. |
